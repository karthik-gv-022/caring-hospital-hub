...
const suggestedQuestions = [
  ...
  { icon: Calendar, text: "Which doctors are available today?", label: "Find doctors" },
...
export function ChatbotWidget({ patientId }: ChatbotWidgetProps) {
  ...
  const { messages, isLoading, sendMessage, clearMessages } = useChatbot(patientId);
        ...
        <Card className="w-[380px] h-[600px] flex flex-col shadow-2xl border-primary/20">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Symptom checker • Appointments • Q&A
                  </p>
                </div>
              </div>
          ...
          <div className="flex-shrink-0 p-4 border-t">
            ...
            <p className="text-xs text-muted-foreground mt-2 text-center">
              AI responses are for guidance only. Consult a doctor for medical advice.
            </p>
          </div>
        </Card>
      </div>
